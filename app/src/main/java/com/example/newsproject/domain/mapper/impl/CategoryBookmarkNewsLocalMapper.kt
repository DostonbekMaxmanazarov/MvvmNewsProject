...
class CategoryBookmarkNewsLocalMapper : ISingleMapper<CategoryNewsItemModel, BookmarkNewsEntity> {
    override fun invoke(value: CategoryNewsItemModel): BookmarkNewsEntity = BookmarkNewsEntity(
        name = value.name,
        title = value.title,
