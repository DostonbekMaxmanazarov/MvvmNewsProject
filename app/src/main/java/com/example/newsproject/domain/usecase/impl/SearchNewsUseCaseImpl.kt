...
class SearchNewsUseCaseImpl @Inject constructor(
    ...
    @SearchNewsModuleMapper private val newsRemoteMapper: ISingleMapper<ArticleDataResponse, SearchNewsItemModel>,
) : ISearchNewsUseCase {

    override suspend fun invoke(searchText: String): ResultEvent<List<SearchNewsItemModel>> {
